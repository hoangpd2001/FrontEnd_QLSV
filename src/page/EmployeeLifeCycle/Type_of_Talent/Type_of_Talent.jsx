    ...
    <div className='type-of-talent'>
        ...
        <div className="type-of-talent-table-header">
              <div className="type-of-talent-search-filter">
                  <input className="type-of-talent-search-filter-input" type="text" placeholder='Tìm Kiếm' />
              </div>
              <div className="type-of-talent-insert">
                  <button className='type-of-talent-insert-button'> + Thêm Khiếu Nại </button>
              </div>
              <div className="type-of-talent-filter">
                  <button className='type-of-talent-filter-coponent'><Filter className="filter-icon"/><span>Bộ Lọc</span></button>
                  <button className='type-of-talent-filter-coponent'><div className="filter-icon"/><span>Tác Vụ</span></button>
              </div>
        </div>

    ...
    <div className='trainning-new-imployee'>
        ...
        <div className="trainning-new-imployee-table-header">
              <div className="trainning-new-imployee-search-filter">
                  <input className="trainning-new-imployee-search-filter-input" type="text" placeholder='Tìm Kiếm' />
              </div>
              <div className="trainning-new-imployee-insert">
                  <button className='trainning-new-imployee-insert-button'> + Thêm Đào Tạo </button>
              </div>
              <div className="trainning-new-imployee-filter">
                  <button className='trainning-new-imployee-filter-coponent'><Filter className="filter-icon"/><span>Bộ Lọc</span></button>
                  <button className='trainning-new-imployee-filter-coponent'><div className="filter-icon"/><span>Tác Vụ</span></button>
              </div>
        </div>

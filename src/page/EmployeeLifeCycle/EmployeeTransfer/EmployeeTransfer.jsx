    ...
    <div className='employee-transfer'>
        ...
        <div className="employee-transfer-table-header">
              <div className="employee-transfer-search-filter">
                  <input className="employee-transfer-search-filter-input" type="text" placeholder='Tìm Kiếm' />
              </div>
              <div className="employee-transfer-insert">
                  <button className='employee-transfer-insert-button'> + Thêm Điều Chuyển </button>
              </div>
              <div className="employee-transfer-filter">
                  <button className='employee-transfer-filter-coponent'><Filter className="filter-icon"/><span>Bộ Lọc</span></button>
                  <button className='employee-transfer-filter-coponent'><div className="filter-icon"/><span>Tác Vụ</span></button>
              </div>
        </div>
